...
export default function AddOrderModal({ onClose }: Props) {
  ...
  const warrantyOptions = loadLS<string[]>('settings_warranty', [
    'بدون ضمان',
    '3 أشهر',
    '6 أشهر',
    'سنة',
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[hsl(var(--muted-foreground))] mt-1">
                          ...
                          <span className="text-amber-700 font-semibold">
                            يستبدل تكلفة الشحن الافتراضية ({ADMIN_SETTINGS.SHIPPING_FEE} ج.م)
                          </span>
                        </p>
                      </div>
                    </label>
                  ...
                  <div className="bg-[hsl(var(--primary))]/5 border border-[hsl(var(--primary))]/20 rounded-2xl p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className={`font-mono ${expressShipping ? 'text-amber-700' : ''}`}>
                          {shippingCost} ج.م
                        </span>
                      </div>
