...
const defaultUsers: AppUser[] = [
  {
    ...
    sessions: [
      ...
      },
      {
        ...
        ...formatSession('2026-03-27T14:10:00'),
      },
      {
        id: 's3',
        userId: 'u1',
        ...
        ...formatSession('2026-03-26T08:15:00'),
      },
      {
        id: 's4',
        userId: 'u1',
        ...
        ...formatSession('2026-03-26T17:00:00'),
      },
    ],
  },
  {
    ...
    sessions: [
      {
        ...
        type: 'login',
        device: 'موبايل',
        timestamp: '2026-03-26T11:15:42',
        ...formatSession('2026-03-26T11:15:42'),
      },
      {
        id: 's6',
        userId: 'u2',
        ...
        ...formatSession('2026-03-26T18:30:00'),
      },
      {
        id: 's7',
        userId: 'u2',
        ...
        ...formatSession('2026-03-25T09:00:00'),
      },
    ],
  },
  {
    ...
    sessions: [
      {
        ...
        type: 'login',
        device: 'كمبيوتر',
        timestamp: '2026-03-25T08:40:51',
        ...formatSession('2026-03-25T08:40:51'),
      },
      {
        id: 's9',
        userId: 'u3',
        ...
        ...formatSession('2026-03-25T16:00:00'),
      },
    ],
  },
  {
    ...
    sessions: [
      {
        ...
        type: 'login',
        device: 'تابلت',
        timestamp: '2026-03-20T14:22:05',
        ...formatSession('2026-03-20T14:22:05'),
      },
      {
        id: 's11',
        userId: 'u4',
        ...
        ...formatSession('2026-03-20T19:00:00'),
      },
    ],
  },
  {
    ...
    sessions: [
      {
        ...
        type: 'login',
        device: 'موبايل',
        timestamp: '2026-03-27T13:40:07',
        ...formatSession('2026-03-27T13:40:07'),
      },
      {
        id: 's13',
        userId: 'u5',
        ...
        ...formatSession('2026-03-27T20:00:00'),
      },
    ],
  },
];
