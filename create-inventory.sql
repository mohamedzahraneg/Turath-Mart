...
CREATE TABLE IF NOT EXISTS public.zahranship_inventory (
...
ALTER TABLE public.zahranship_inventory ENABLE ROW LEVEL SECURITY;
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE tablename = 'zahranship_inventory' 
        ...
        ON public.zahranship_inventory
...
INSERT INTO public.zahranship_inventory (name, sku, available, withdrawn, min_stock, price, category, colors)
VALUES 
